-- 0004 — audit/history: append-only row_history + first/last_seen tracking.
--
-- Idempotent. Mirrors the previously freya-only k8s/freya-db/002-audit-history.sql
-- and is now part of the shared migration sequence for all environments.
-- Requires the csearch role from 0000.
