-- 0001 — initial public schema (bills, votes, committees, search functions).
--
-- This is the byte-for-byte public-schema bootstrap. It is kept identical to
-- backend/scraper/schema.sql and k8s/{netcup,freya}-db/001-schema.sql, which
-- bootstrap the live clusters; scripts/check-schema-drift.sh fails CI if they
-- diverge. Requires the csearch role from 0000.
