...
**Triggers:** push to `main` touching `frontend/**` or `.github/workflows/frontend-cloudflare-deploy.yml`; daily at 12:00 UTC (keeps the site fresh with latest bill data); `workflow_dispatch`.
