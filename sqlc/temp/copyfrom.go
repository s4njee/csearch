...
func (q *Queries) InsertBill(ctx context.Context, arg []InsertBillParams) (int64, error) {
	return q.db.CopyFrom(ctx, []string{"bills_temp"}, []string{"billid", "billnumber", "billtype", "introducedat", "congress", "summary", "actions", "sponsors", "cosponsors", "statusat", "shorttitle", "officialtitle"}, &iteratorForInsertBill{rows: arg})
}
